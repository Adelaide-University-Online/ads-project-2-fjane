...
public class MapGraph implements Graph{
    ...
    */
     ...
     * @param weight a double representing the weight of the optitime.Edge
     */
    public boolean addEdge(int sourceId, int destinationId, double weight) {
        ...
        edges.get(sourceId).add(new Edge(sourceId, destinationId, weight));
        ...
        if(!directed) {
            edges.get(destinationId).add(new Edge(destinationId, sourceId, weight));
